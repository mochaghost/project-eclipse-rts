...
import { X, Save, Cloud, Database, Sliders, Volume2, Monitor, Eye, Info, Link, Table, CheckCircle2, FileJson, Copy, Smartphone, Move, Share2, UploadCloud, DownloadCloud, AlertTriangle, Key } from 'lucide-react';
            ...
            <div className="relative w-full max-w-2xl bg-[#0c0a09] border-2 border-stone-700 h-[85vh] flex flex-col shadow-2xl">
                ...
                <div className="flex border-b border-stone-800 bg-[#151210]">
                    ...
                    <button onClick={() => setTab('CLOUD')} className={`flex-1 py-4 text-xs font-bold tracking-widest ${tab === 'CLOUD' ? 'text-blue-400 border-b-2 border-blue-400 bg-[#1c1917]' : 'text-stone-500 hover:text-stone-300'}`}>
                        <Cloud className="inline mr-2 mb-0.5" size={14}/> SOUL LINK
                    </button>
                </div>
                    ...
                    {tab === 'GENERAL' ? (
                        ...
                        user ? (
                            <div className="text-center py-6 animate-fade-in">
                                <div className="text-green-500 text-xl font-bold mb-2 font-serif tracking-widest">SOUL LINK ESTABLISHED</div>
                             ...
                             <div className="space-y-6 h-full flex flex-col justify-center pb-20">
                                <div className="bg-[#151210] p-8 border border-stone-800 text-center">
                                    <h4 className="text-stone-300 text-sm font-bold mb-4 flex items-center justify-center gap-2 uppercase tracking-widest"><Cloud size={14}/> Cloud Sync</h4>
                                    <p className="text-[10px] text-stone-500 mb-6 leading-relaxed">
                                        Sign in to bind your timeline to your soul. <br/>
                                        This allows you to access your citadel from any device automatically.
                                    </p>
                                    
                                    <button 
                                        onClick={loginWithGoogle}
                                        className="w-full bg-white text-black font-bold py-4 px-6 flex items-center justify-center gap-3 hover:bg-gray-200 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.2)]"
                                    >
